...
#define TEST_DEVICE_NAME            "ESP_MOTO_DEMO"
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        // rsp.attr_value.value[2] = moto_chassis[0].speed_rpm>>8;
    ...
    case ESP_GATTS_WRITE_EVT: {
        ESP_LOGI(GATTS_TAG, "A__GATT_WRITE_EVT, conn_id %d, trans_id %d, handle %d", param->write.conn_id, param->write.trans_id, param->write.handle);
        if (!param->write.is_prep){
